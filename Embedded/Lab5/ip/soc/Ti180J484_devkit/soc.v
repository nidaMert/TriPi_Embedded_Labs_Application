...
`define IP_UUID _c738d0e3dbf04358be6fed819c809706
...
// Component : EfxSapphireSoc_c738d0e3dbf04358be6fed819c809706

`timescale 1ns/1ps

module EfxSapphireSoc_c738d0e3dbf04358be6fed819c809706 (
  input               io_systemClk,
  input               io_asyncReset,
  input               jtagCtrl_tck,
  input               userInterruptA,
  ...
  BufferCC_c738d0e3dbf04358be6fed819c809706 bufferCC_6 (
  ...
  BufferCC_1_c738d0e3dbf04358be6fed819c809706 bufferCC_7 (
    .io_dataIn                 (bufferCC_7_io_dataIn     ), //i
    .io_dataOut                (bufferCC_7_io_dataOut    ), //o
    .io_systemClk              (io_systemClk             ), //i
    .debugCd_logic_outputReset (debugCd_logic_outputReset)  //i
  );
  VexRiscv_c738d0e3dbf04358be6fed819c809706 system_cores_0_logic_cpu (
  ...
  BufferCC_2_c738d0e3dbf04358be6fed819c809706 userInterruptA_buffercc (
    .io_dataIn                  (userInterruptA                    ), //i
    .io_dataOut                 (userInterruptA_buffercc_io_dataOut), //o
    .io_systemClk               (io_systemClk                      ), //i
    .systemCd_logic_outputReset (systemCd_logic_outputReset        )  //i
  );
  JtagBridgeNoTap_c738d0e3dbf04358be6fed819c809706 system_hardJtag_debug_logic_jtagBridge (
  ...
  SystemDebugger_c738d0e3dbf04358be6fed819c809706 system_hardJtag_debug_logic_debugger (
  ...
  BufferCC_3_c738d0e3dbf04358be6fed819c809706 bufferCC_8 (
    .io_dataIn                 (bufferCC_8_io_dataIn     ), //i
    .io_dataOut                (bufferCC_8_io_dataOut    ), //o
    .io_systemClk              (io_systemClk             ), //i
    .system_cores_0_debugReset (system_cores_0_debugReset)  //i
  );
  BmbArbiter_c738d0e3dbf04358be6fed819c809706 system_bridge_bmb_arbiter (
  ...
  BmbDecoder_c738d0e3dbf04358be6fed819c809706 system_cores_0_iBus_decoder (
  ...
  BmbToAxi4SharedBridge_c738d0e3dbf04358be6fed819c809706 system_axiA_logic_bmbToAxiBridge (
  ...
  BmbDecoder_1_c738d0e3dbf04358be6fed819c809706 system_bridge_bmb_decoder (
  ...
  BmbDecoder_2_c738d0e3dbf04358be6fed819c809706 bmbDecoder_4 (
  ...
  BmbOnChipRam_c738d0e3dbf04358be6fed819c809706 system_ramA_logic (
  ...
  BmbDecoder_3_c738d0e3dbf04358be6fed819c809706 system_bmbPeripheral_bmb_decoder (
  ...
  BmbClint_c738d0e3dbf04358be6fed819c809706 system_clint_logic (
  ...
  BmbUartCtrl_c738d0e3dbf04358be6fed819c809706 system_uart_0_io_logic (
  ...
  BmbSpiXdrMasterCtrl_c738d0e3dbf04358be6fed819c809706 system_spi_0_io_logic (
  ...
  BmbToApb3Bridge_c738d0e3dbf04358be6fed819c809706 io_apbSlave_0_logic (
...
module BmbToApb3Bridge_c738d0e3dbf04358be6fed819c809706 (
...
module BmbSpiXdrMasterCtrl_c738d0e3dbf04358be6fed819c809706 (
  ...
  TopLevel_c738d0e3dbf04358be6fed819c809706 ctrl (
  ...
  StreamFifo_c738d0e3dbf04358be6fed819c809706 mapping_cmdLogic_streamUnbuffered_queueWithAvailability (
  ...
  StreamFifo_1_c738d0e3dbf04358be6fed819c809706 system_spi_0_io_logic_ctrl_io_rsp_queueWithOccupancy (
...
module BmbUartCtrl_c738d0e3dbf04358be6fed819c809706 (
  ...
  UartCtrl_c738d0e3dbf04358be6fed819c809706 uartCtrl_1 (
  ...
  StreamFifo_2_c738d0e3dbf04358be6fed819c809706 bridge_write_streamUnbuffered_queueWithOccupancy (
  ...
  StreamFifo_2_c738d0e3dbf04358be6fed819c809706 system_uart_0_io_logic_uartCtrl_1_io_read_queueWithOccupancy (
...
module BmbClint_c738d0e3dbf04358be6fed819c809706 (
  input               io_bus_cmd_valid,
  output              io_bus_cmd_ready,
  input               io_bus_cmd_payload_last,
  input      [0:0]    io_bus_cmd_payload_fragment_source,
...
module BmbDecoder_3_c738d0e3dbf04358be6fed819c809706 (
  input               io_input_cmd_valid,
  output              io_input_cmd_ready,
  input               io_input_cmd_payload_last,
  input      [0:0]    io_input_cmd_payload_fragment_source,
...
module BmbOnChipRam_c738d0e3dbf04358be6fed819c809706 (
  input               io_bus_cmd_valid,
  output              io_bus_cmd_ready,
  input               io_bus_cmd_payload_last,
  input      [0:0]    io_bus_cmd_payload_fragment_source,
...
module BmbDecoder_2_c738d0e3dbf04358be6fed819c809706 (
  input               io_input_cmd_valid,
  output              io_input_cmd_ready,
  input               io_input_cmd_payload_last,
  input      [0:0]    io_input_cmd_payload_fragment_opcode,
...
module BmbDecoder_1_c738d0e3dbf04358be6fed819c809706 (
  input               io_input_cmd_valid,
  output              io_input_cmd_ready,
  input               io_input_cmd_payload_last,
  input      [0:0]    io_input_cmd_payload_fragment_source,
...
module BmbToAxi4SharedBridge_c738d0e3dbf04358be6fed819c809706 (
  input               io_input_cmd_valid,
  output              io_input_cmd_ready,
  input               io_input_cmd_payload_last,
  input      [0:0]    io_input_cmd_payload_fragment_source,
  ...
  StreamFifo_4_c738d0e3dbf04358be6fed819c809706 writeCmdInfo_fifo (
  ...
  StreamFifo_4_c738d0e3dbf04358be6fed819c809706 readCmdInfo_fifo (
...
module BmbDecoder_c738d0e3dbf04358be6fed819c809706 (
  input               io_input_cmd_valid,
  output              io_input_cmd_ready,
  input               io_input_cmd_payload_last,
  input      [0:0]    io_input_cmd_payload_fragment_opcode,
...
module BmbArbiter_c738d0e3dbf04358be6fed819c809706 (
  ...
  StreamArbiter_c738d0e3dbf04358be6fed819c809706 memory_arbiter (
...
module BufferCC_3_c738d0e3dbf04358be6fed819c809706 (
  input               io_dataIn,
  output              io_dataOut,
  input               io_systemClk,
...
module SystemDebugger_c738d0e3dbf04358be6fed819c809706 (
...
module JtagBridgeNoTap_c738d0e3dbf04358be6fed819c809706 (
  input               io_ctrl_tdi,
  ...
  FlowCCByToggle_c738d0e3dbf04358be6fed819c809706 flowCCByToggle_1 (
...
module BufferCC_2_c738d0e3dbf04358be6fed819c809706 (
  input               io_dataIn,
  output              io_dataOut,
  input               io_systemClk,
  input               systemCd_logic_outputReset
...
module VexRiscv_c738d0e3dbf04358be6fed819c809706 (
  ...
  StreamFifoLowLatency_c738d0e3dbf04358be6fed819c809706 IBusSimplePlugin_rspJoin_rspBuffer_c (
  ...
  EfxCPUSp1_c738d0e3dbf04358be6fed819c809706 EfxCPUSp1_inst (
  ...
  EfxCPUSp2_c738d0e3dbf04358be6fed819c809706 EfxCPUSp2_inst (
...
module BufferCC_1_c738d0e3dbf04358be6fed819c809706 (
  input               io_dataIn,
  output              io_dataOut,
  input               io_systemClk,
  input               debugCd_logic_outputReset
...
module BufferCC_c738d0e3dbf04358be6fed819c809706 (
  input               io_dataIn,
  output              io_dataOut,
  input               io_systemClk,
  input               io_asyncReset
...
module StreamFifo_1_c738d0e3dbf04358be6fed819c809706 (
  input               io_push_valid,
...
module StreamFifo_c738d0e3dbf04358be6fed819c809706 (
  input               io_push_valid,
  output              io_push_ready,
...
module TopLevel_c738d0e3dbf04358be6fed819c809706 (
...
//StreamFifo_3 replaced by StreamFifo_2_c738d0e3dbf04358be6fed819c809706

module StreamFifo_2_c738d0e3dbf04358be6fed819c809706 (
  input               io_push_valid,
  output              io_push_ready,
...
module UartCtrl_c738d0e3dbf04358be6fed819c809706 (
  ...
  UartCtrlTx_c738d0e3dbf04358be6fed819c809706 tx (
  ...
  UartCtrlRx_c738d0e3dbf04358be6fed819c809706 rx (
    .io_configFrame_dataLength  (io_config_frame_dataLength[2:0]), //i
    .io_configFrame_stop        (io_config_frame_stop           ), //i
    .io_configFrame_parity      (io_config_frame_parity[1:0]    ), //i
    .io_samplingTick            (clockDivider_tickReg           ), //i
...
//StreamFifo_5 replaced by StreamFifo_4_c738d0e3dbf04358be6fed819c809706

module StreamFifo_4_c738d0e3dbf04358be6fed819c809706 (
  input               io_push_valid,
  output              io_push_ready,
...
module StreamArbiter_c738d0e3dbf04358be6fed819c809706 (
...
module FlowCCByToggle_c738d0e3dbf04358be6fed819c809706 (
  ...
  BufferCC_4_c738d0e3dbf04358be6fed819c809706 inputArea_target_buffercc (
...
module StreamFifoLowLatency_c738d0e3dbf04358be6fed819c809706 (
  input               io_push_valid,
  output              io_push_ready,
...
module UartCtrlRx_c738d0e3dbf04358be6fed819c809706 (
  ...
  BufferCC_5_c738d0e3dbf04358be6fed819c809706 io_rxd_buffercc (
    .io_dataIn                  (io_rxd                    ), //i
...
module UartCtrlTx_c738d0e3dbf04358be6fed819c809706 (
  input      [2:0]    io_configFrame_dataLength,
  input      [0:0]    io_configFrame_stop,
  input      [1:0]    io_configFrame_parity,
  input               io_samplingTick,
...
module BufferCC_4_c738d0e3dbf04358be6fed819c809706 (
  input               io_dataIn,
  output              io_dataOut,
  input               io_systemClk,
  input               debugCd_logic_outputReset
...
module BufferCC_5_c738d0e3dbf04358be6fed819c809706 (
  input               io_dataIn,
  output              io_dataOut,
  input               io_systemClk,
  input               systemCd_logic_outputReset
...
module EfxCPUSp1_c738d0e3dbf04358be6fed819c809706 (
  input      [31:0]   src1,
  input      [31:0]   src2,
  input      [1:0]    bitCtrl,
  input      [1:0]    ctrl,
...
module EfxCPUSp2_c738d0e3dbf04358be6fed819c809706 (
  input      [1:0]    ctrl,
  input      [31:0]   src1,
  input      [31:0]   src2,
  output     [31:0]   result
