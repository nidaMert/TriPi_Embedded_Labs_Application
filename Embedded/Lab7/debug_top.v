...
module edb_top (
    ...
    input  [3:0] la0_ain,
    input  [3:0] la0_bin,
    input  [3:0] la0_ain_vio,
    input  [3:0] la0_bin_vio,
    input  [3:0] la0_result,
    input  la0_select,
    input  la0_axi_awvalid,
    input  la0_axi_awready,
    input  la0_axi_wready,
    input  la0_axi_wvalid,
    input  vio0_clk,
    output [3:0] vio0_ain_vio,
    output [3:0] vio0_bin_vio,
    output vio0_select
);
    ...
    assign vio0_module_select       = edb_module_selects[1];
    assign edb_module_inhibit[1]    = vio0_module_inhibit;
    assign edb_module_tdo[1]        = vio0_module_tdo;
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'hb67aef1b6f1844cbada17f443b5f6125 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 4 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 4 ),
        ...
        .probe4                 ( la0_result ),
        .probe5                 ( la0_select ),
        .probe6                 ( la0_axi_awvalid ),
        .probe7                 ( la0_axi_awready ),
        .probe8                 ( la0_axi_wready ),
        .probe9                 ( la0_axi_wvalid )
    );

    edb_vio_top #(
        .NUM_PROBE_IN           ( 0 ),
        .NUM_PROBE_OUT          ( 3 ),
        .UUID           ( 128'h8306aa0106a146588166b12a0e0e5431 ),
        .PROBE_OUT0_WIDTH       ( 4 ),
        .PROBE_OUT1_WIDTH       ( 4 ),
        .PROBE_OUT2_WIDTH       ( 1 ),
        ...
        .probe_in62         ( 1'b0 ),
        .probe_in63         ( 1'b0 ),
        .probe_out0         ( vio0_ain_vio ),
        .probe_out1         ( vio0_bin_vio ),
        .probe_out2         ( vio0_select ),
        .probe_out3         (  ),
        .probe_out4         (  ),
        .probe_out5         (  ),
        .probe_out6         (  ),
