...
/******************************************************************************
*
* @file main.c: compatibilityDemo
*
* @brief This demo shows how to migrate an application from the Sapphire Soc v1.1 to v2.0.
*        To run your previously developed software applications on v2.0, include compability.h 
*        and bsp.h at the top of your code. These files map the v2.0 code and driver changes 
*        to the old SoC version.
*
* @note Please ensure to include "compatibility.h" to have backward compatible with 
...
/******************************************************************************
*
* @brief This main function initialize timer and waiting to be interrupted by 
*        the timer. 
*
******************************************************************************/
void main() {
...
/******************************************************************************
*
* @brief This function handles timer interrupt event. 
*
******************************************************************************/
void timerInterrupt(){
    static uint32_t counter = 0;
    scheduleTimer();
    bsp_printf("BSP_MACHINE_TIMER %d \r\n", counter);
...
/******************************************************************************
*
* @brief This function handles GPIO interrupts by claiming pending interrupts 
* 		 and print a message regarding the claimed interrupt. 
*
******************************************************************************/
void externalInterrupt(){
    uint32_t claim;
    ...
    while(claim = plic_claim(BSP_PLIC, BSP_PLIC_CPU_0)){
        switch(claim){
        case PLIC_GPIO_A_0: bsp_printf("PLIC_GPIO_A_0\r\n"); break;
        default: crash(); break;
        }
