...
/******************************************************************************
*
* @brief This main function prints three different datas which the first data are directly 
*        written into the memory and the second data is overwritten by memory_checker module 
*        and the last data was shown in terminal after data cache invalidation to compare the 
*        differences of these three datas and the importance of data cache invalidation.
*
******************************************************************************/
void main() {
