...
f9000004:	e2018193          	addi	gp,gp,-480 # f9000e20 <__global_pointer$>
...
init:
	la sp, _sp
f9000008:	a3018113          	addi	sp,gp,-1488 # f9000850 <__freertos_irq_stack_top>

	/* Load data section */
	la a0, _data_lma
f900000c:	00000517          	auipc	a0,0x0
f9000010:	56450513          	addi	a0,a0,1380 # f9000570 <_data>
	la a1, _data
f9000014:	00000597          	auipc	a1,0x0
f9000018:	55c58593          	addi	a1,a1,1372 # f9000570 <_data>
	la a2, _edata
f900001c:	81c18613          	addi	a2,gp,-2020 # f900063c <owrite_crtl>
	bgeu a1, a2, 2f
...
2:
	...
	/* Clear bss section */
	la a0, __bss_start
f9000038:	81c18513          	addi	a0,gp,-2020 # f900063c <owrite_crtl>
	la a1, _end
f900003c:	82818593          	addi	a1,gp,-2008 # f9000648 <_end>
	bgeu a0, a1, 2f
...
f9000050:	010000ef          	jal	ra,f9000060 <__libc_init_array>
	...
	call main
f9000054:	49c000ef          	jal	ra,f90004f0 <main>
...
f9000070:	50440413          	addi	s0,s0,1284 # f9000570 <_data>
f9000074:	00000917          	auipc	s2,0x0
f9000078:	4fc90913          	addi	s2,s2,1276 # f9000570 <_data>
...
f90000ac:	4c840413          	addi	s0,s0,1224 # f9000570 <_data>
f90000b0:	00000917          	auipc	s2,0x0
f90000b4:	4c090913          	addi	s2,s2,1216 # f9000570 <_data>
...
f90001bc:	57078793          	addi	a5,a5,1392 # f9000570 <__global_pointer$+0xfffff750>
...
f9000210:	58478793          	addi	a5,a5,1412 # f9000584 <__global_pointer$+0xfffff764>
...
f9000488:	59850513          	addi	a0,a0,1432 # f9000598 <__global_pointer$+0xfffff778>
...
f90004dc:	00112623          	sw	ra,12(sp)
    bsp_printf("Failed! \r\n");
f90004e0:	f9000537          	lui	a0,0xf9000
f90004e4:	5e450513          	addi	a0,a0,1508 # f90005e4 <__global_pointer$+0xfffff7c4>
f90004e8:	e89ff0ef          	jal	ra,f9000370 <bsp_printf>
    while (1) {}
f90004ec:	0000006f          	j	f90004ec <error_state+0x14>
...
******************************************************************************/
void main() {
f90004f0:	fe010113          	addi	sp,sp,-32
f90004f4:	00112e23          	sw	ra,28(sp)
f90004f8:	00812c23          	sw	s0,24(sp)
    struct ctrl_reg cfg0={0};
f90004fc:	00012623          	sw	zero,12(sp)
...
f9000504:	5f050513          	addi	a0,a0,1520 # f90005f0 <__global_pointer$+0xfffff7d0>
f9000508:	e69ff0ef          	jal	ra,f9000370 <bsp_printf>
    cfg0.lfsr_stop = 0;
f900050c:	00c12783          	lw	a5,12(sp)
f9000510:	ffe7f793          	andi	a5,a5,-2
f9000514:	00f12623          	sw	a5,12(sp)
    apb3_ctrl_write(APB0, &cfg0);
f9000518:	00c10593          	addi	a1,sp,12
f900051c:	f8100537          	lui	a0,0xf8100
f9000520:	f91ff0ef          	jal	ra,f90004b0 <apb3_ctrl_write>
    cfg0.lfsr_stop = 1;
f9000524:	00c12783          	lw	a5,12(sp)
f9000528:	0017e793          	ori	a5,a5,1
f900052c:	00f12623          	sw	a5,12(sp)
    apb3_ctrl_write(APB0, &cfg0);
f9000530:	00c10593          	addi	a1,sp,12
f9000534:	f8100537          	lui	a0,0xf8100
f9000538:	f79ff0ef          	jal	ra,f90004b0 <apb3_ctrl_write>
    data = apb3_read(APB0);
f900053c:	f8100537          	lui	a0,0xf8100
f9000540:	f69ff0ef          	jal	ra,f90004a8 <apb3_read>
f9000544:	00050413          	mv	s0,a0
    bsp_printf("Random number: 0x%x \r\n", data);
f9000548:	00050593          	mv	a1,a0
f900054c:	f9000537          	lui	a0,0xf9000
f9000550:	60850513          	addi	a0,a0,1544 # f9000608 <__global_pointer$+0xfffff7e8>
f9000554:	e1dff0ef          	jal	ra,f9000370 <bsp_printf>
    if(data == 0x0)
f9000558:	00040a63          	beqz	s0,f900056c <main+0x7c>
        error_state();
    else
        bsp_printf("Passed! \r\n");
f900055c:	f9000537          	lui	a0,0xf9000
f9000560:	62050513          	addi	a0,a0,1568 # f9000620 <__global_pointer$+0xfffff800>
f9000564:	e0dff0ef          	jal	ra,f9000370 <bsp_printf>
f9000568:	f99ff06f          	j	f9000500 <main+0x10>
        error_state();
f900056c:	f6dff0ef          	jal	ra,f90004d8 <error_state>
