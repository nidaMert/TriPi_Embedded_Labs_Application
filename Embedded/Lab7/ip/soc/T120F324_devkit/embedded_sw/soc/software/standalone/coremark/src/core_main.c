...
/******************************************************************************
*
* @file core_main.c: Coremark
*
* @brief This benchmark application measure CPU performance. The final score is calculated 
*        based on the result of algorithm processing (e.g., list processing, matrix 
*        manipulation, state machine, and CRC). This application is configured to run 2,000
*        iterations with a runtime of approximately 20s.
*
******************************************************************************/
#include "coremark.h"
...
main(void)
{
    int   argc = 0;
    char *argv[1];
    ee_printf("coremark app is running, please wait...");
#else
MAIN_RETURN_TYPE
