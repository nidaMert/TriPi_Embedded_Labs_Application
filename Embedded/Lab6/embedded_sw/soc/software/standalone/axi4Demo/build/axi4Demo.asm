...
f9000004:	fd018193          	addi	gp,gp,-48 # f9000fd0 <__global_pointer$>
...
init:
	la sp, _sp
f9000008:	a2018113          	addi	sp,gp,-1504 # f90009f0 <__freertos_irq_stack_top>

	/* Load data section */
	la a0, _data_lma
f900000c:	00000517          	auipc	a0,0x0
f9000010:	71050513          	addi	a0,a0,1808 # f900071c <_data>
	la a1, _data
f9000014:	00000597          	auipc	a1,0x0
f9000018:	70858593          	addi	a1,a1,1800 # f900071c <_data>
	la a2, _edata
f900001c:	81c18613          	addi	a2,gp,-2020 # f90007ec <__bss_start>
	bgeu a1, a2, 2f
...
2:
	...
	/* Clear bss section */
	la a0, __bss_start
f9000038:	81c18513          	addi	a0,gp,-2020 # f90007ec <__bss_start>
	la a1, _end
f900003c:	82018593          	addi	a1,gp,-2016 # f90007f0 <_end>
	bgeu a0, a1, 2f
...
f9000070:	6b040413          	addi	s0,s0,1712 # f900071c <_data>
f9000074:	00000917          	auipc	s2,0x0
f9000078:	6a890913          	addi	s2,s2,1704 # f900071c <_data>
...
f90000ac:	67440413          	addi	s0,s0,1652 # f900071c <_data>
f90000b0:	00000917          	auipc	s2,0x0
f90000b4:	66c90913          	addi	s2,s2,1644 # f900071c <_data>
...
f90001bc:	71c78793          	addi	a5,a5,1820 # f900071c <__global_pointer$+0xfffff74c>
...
f9000210:	73078793          	addi	a5,a5,1840 # f9000730 <__global_pointer$+0xfffff760>
...
f90003a4:	00068a63          	beqz	a3,f90003b8 <plic_set_enable+0x38>
        return *((volatile u32*) address);
f90003a8:	00052603          	lw	a2,0(a0) # f8010000 <__global_pointer$+0xff00f030>
...
f9000534:	74450513          	addi	a0,a0,1860 # f9000744 <__global_pointer$+0xfffff774>
...
f9000560:	79050513          	addi	a0,a0,1936 # f9000790 <__global_pointer$+0xfffff7c0>
...
f9000578:	79c50513          	addi	a0,a0,1948 # f900079c <__global_pointer$+0xfffff7cc>
...
f90005c4:	68c78793          	addi	a5,a5,1676 # f900068c <__global_pointer$+0xfffff6bc>
...
f9000624:	7b050513          	addi	a0,a0,1968 # f90007b0 <__global_pointer$+0xfffff7e0>
...
f9000688:	0000006f          	j	f9000688 <main>
...
trap_entry:
  addi sp,sp, -16*4
f900068c:	fc010113          	addi	sp,sp,-64
  sw x1,   0*4(sp)
f9000690:	00112023          	sw	ra,0(sp)
  sw x5,   1*4(sp)
f9000694:	00512223          	sw	t0,4(sp)
  sw x6,   2*4(sp)
f9000698:	00612423          	sw	t1,8(sp)
  sw x7,   3*4(sp)
f900069c:	00712623          	sw	t2,12(sp)
  sw x10,  4*4(sp)
f90006a0:	00a12823          	sw	a0,16(sp)
  sw x11,  5*4(sp)
f90006a4:	00b12a23          	sw	a1,20(sp)
  sw x12,  6*4(sp)
f90006a8:	00c12c23          	sw	a2,24(sp)
  sw x13,  7*4(sp)
f90006ac:	00d12e23          	sw	a3,28(sp)
  sw x14,  8*4(sp)
f90006b0:	02e12023          	sw	a4,32(sp)
  sw x15,  9*4(sp)
f90006b4:	02f12223          	sw	a5,36(sp)
  sw x16, 10*4(sp)
f90006b8:	03012423          	sw	a6,40(sp)
  sw x17, 11*4(sp)
f90006bc:	03112623          	sw	a7,44(sp)
  sw x28, 12*4(sp)
f90006c0:	03c12823          	sw	t3,48(sp)
  sw x29, 13*4(sp)
f90006c4:	03d12a23          	sw	t4,52(sp)
  sw x30, 14*4(sp)
f90006c8:	03e12c23          	sw	t5,56(sp)
  sw x31, 15*4(sp)
f90006cc:	03f12e23          	sw	t6,60(sp)
  call trap
f90006d0:	f85ff0ef          	jal	ra,f9000654 <trap>
  lw x1 ,  0*4(sp)
f90006d4:	00012083          	lw	ra,0(sp)
  lw x5,   1*4(sp)
f90006d8:	00412283          	lw	t0,4(sp)
  lw x6,   2*4(sp)
f90006dc:	00812303          	lw	t1,8(sp)
  lw x7,   3*4(sp)
f90006e0:	00c12383          	lw	t2,12(sp)
  lw x10,  4*4(sp)
f90006e4:	01012503          	lw	a0,16(sp)
  lw x11,  5*4(sp)
f90006e8:	01412583          	lw	a1,20(sp)
  lw x12,  6*4(sp)
f90006ec:	01812603          	lw	a2,24(sp)
  lw x13,  7*4(sp)
f90006f0:	01c12683          	lw	a3,28(sp)
  lw x14,  8*4(sp)
f90006f4:	02012703          	lw	a4,32(sp)
  lw x15,  9*4(sp)
f90006f8:	02412783          	lw	a5,36(sp)
  lw x16, 10*4(sp)
f90006fc:	02812803          	lw	a6,40(sp)
  lw x17, 11*4(sp)
f9000700:	02c12883          	lw	a7,44(sp)
  lw x28, 12*4(sp)
f9000704:	03012e03          	lw	t3,48(sp)
  lw x29, 13*4(sp)
f9000708:	03412e83          	lw	t4,52(sp)
  lw x30, 14*4(sp)
f900070c:	03812f03          	lw	t5,56(sp)
  lw x31, 15*4(sp)
f9000710:	03c12f83          	lw	t6,60(sp)
  addi sp,sp, 16*4
f9000714:	04010113          	addi	sp,sp,64
  mret
f9000718:	30200073          	mret
